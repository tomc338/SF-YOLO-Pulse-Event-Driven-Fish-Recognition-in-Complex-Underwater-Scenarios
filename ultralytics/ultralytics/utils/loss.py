...
class BboxLoss(nn.Module):
    ...
    def __init__(self, reg_max: int = 16, iou_type: str = "CIoU"):
        ...
        Args:
            ...
            iou_type (str): Type of IoU loss to use. Options: "IoU", "GIoU", "DIoU", "CIoU", "ShapeIoU".
                Default: "CIoU"
        """
        super().__init__()
        self.dfl_loss = DFLoss(reg_max) if reg_max > 1 else None
        self.iou_type = iou_type.upper()  # Normalize to uppercase
